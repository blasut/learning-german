...
** En stor blandning av olika ord, fraser och uttryck
   Denna lista används för att peta in ord jag av nån anledning vill spara.
   
   Denna och dom ovanstående finns i "master" i ankiapp. 

   först lägga till här, sedan ankiapp.
    ...
    | hörförståelse       | Hörverstehen          |
    | nyheten             | Die Nachricht         |
    | nyheterna           | Nachrichten           |
    | hålet i tanden      | Das zahnloch          |
    | ses snart           | bis bald              |
    | flugan              | die Fliege            |
    | chokladen           | die Schokolade        |
    | pojken              | der Junge             |
    | Stimmt's so         | Behåll växeln         |
